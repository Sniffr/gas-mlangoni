...
import 'package:mlangoni/data/model/response/chat_model.dart';
import 'package:mlangoni/data/repository/chat_repo.dart';
import 'package:mlangoni/helper/date_converter.dart';
import 'package:mlangoni/helper/user_type.dart';
  ...
  Future<void> getMessages(int offset, NotificationBody notificationBody, User user, int conversationID, {bool firstLoad = false}) async {
    ...
    if (_response != null && _response.body['messages'] != {} && _response.statusCode == 200) {
      if (offset == 1) {
        ...
        /// Manage Receiver
        _messageModel = ChatModel.fromJson(_response.body);
        ...
        _messageModel.totalSize = ChatModel.fromJson(_response.body).totalSize;
        _messageModel.offset = ChatModel.fromJson(_response.body).offset;
        _messageModel.messages.addAll(ChatModel.fromJson(_response.body).messages);
      }
    } else {
