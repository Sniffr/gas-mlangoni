import 'package:mlangoni/data/model/response/choose_us_model.dart';
import 'package:mlangoni/data/model/response/language_model.dart';
import 'package:mlangoni/util/images.dart';

class AppConstants {
  static const String APP_NAME = 'Gas Mlangoni';
  static const double APP_VERSION = 1.6;

  static const String BASE_URL = 'https://gasmlangoni.com';
  ...
  // Shared Key
  static const String THEME = 'ravol_theme';
  static const String TOKEN = 'ravol_token';
  static const String COUNTRY_CODE = 'ravol_country_code';
  static const String LANGUAGE_CODE = 'ravol_language_code';
  static const String CART_LIST = 'ravol_cart_list';
  static const String USER_PASSWORD = 'ravol_user_password';
  static const String USER_ADDRESS = 'ravol_user_address';
  static const String USER_NUMBER = 'ravol_user_number';
  static const String USER_COUNTRY_CODE = 'ravol_user_country_code';
  static const String NOTIFICATION = 'ravol_notification';
  static const String SEARCH_HISTORY = 'ravol_search_history';
  static const String INTRO = 'ravol_intro';
  static const String NOTIFICATION_COUNT = 'ravol_notification_count';
